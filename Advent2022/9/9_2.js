...
//whithtout a 2 dimensional array 

const inputArray = input.split('\n').map((item) => ([item[0], parseInt(item.slice(1))]))


// map the input to an array of moves (direction and distance)
...
const moveHead = (direction, distance) => {
    for (let i = 0; i < distance; i++) {
        ...
        // move tail if head is not adjacent
        currentHead = head;
